...
<Callout title="Node.js" type="info">
...
<Callout title="Installation success" type="success">
  If both commands work without errors, you have successfully installed PriyoScript!
  Congratulations!
</Callout>
