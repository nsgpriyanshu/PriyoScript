...
4. [Syntax Basics](./basics/syntax)
5. [Control Flow](./basics/control-flow)
6. [Functions](./basics/functions)
7. [Classes & OOP](./oop/classes)
8. [Arrays](./basics/arrays)
9. [Modules and Packages](./modules/packages)
10. [Error Handling](./advanced/error-handling)
11. [CLI](./tools/cli)
12. [REPL](./tools/repl)
13. [Error Codes Reference](./reference/errors-reference)
